...
// FIXME update to spring-hateoas 0.24.0 when released to avoid the need for this class, https://github.com/spring-projects/spring-hateoas/issues/288
...
public class Jackson2HalModule extends SimpleModule {
    ...
    public Jackson2HalModule() {
        ...
        log.info("Loaded FINT version of Jackson2HalModule!");
